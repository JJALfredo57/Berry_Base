                    ...
                    <tr style="{{ !$opt->is_active ? 'opacity:.45' : '' }}">
                      ...
                      <td class="ps-3">
                        <div class="d-flex flex-column gap-0">
                          <form action="{{ route('admin.custom_options.sort_up', $opt->id) }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-link btn-sm p-0 text-muted"
                                    style="line-height:1;font-size:.8rem" title="Move up">▲</button>
                          </form>
                          <form action="{{ route('admin.custom_options.sort_down', $opt->id) }}" method="POST">
                            @csrf
                            <button type="submit" class="btn btn-link btn-sm p-0 text-muted"
                      ...
                      <td class="text-end pe-3">
                        <div class="d-flex gap-1 justify-content-end">
                          ...
                          {{-- Toggle --}}
                          <form action="{{ route('admin.custom_options.toggle', $opt->id) }}" method="POST">
                            @csrf
                            <button type="submit"
