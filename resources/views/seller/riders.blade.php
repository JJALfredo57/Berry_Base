        ...
        <div class="card-body p-4">
          ...
          <div class="mb-3 p-2 rounded-2" style="background:#fff7ed;font-size:.78rem">
            ...
            @if($r->emergency_contact_phone)
              — <a href="tel:{{ $r->emergency_contact_phone }}" class="text-decoration-none" style="color:#ea580c">{{ $r->emergency_contact_phone }}</a>
            @endif
          </div>
          @endif
          ...
          <div class="d-flex gap-2">
            ...
            <form action="{{ route('seller.riders.toggle', $r->id) }}" method="POST" class="flex-fill">
              @csrf
    ...
    <div class="modal fade" id="editRiderModal{{ $r->id }}" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width:480px">
        <div class="modal-content border-0" style="border-radius:1.2rem;overflow:hidden">
          ...
          <form action="{{ route('seller.riders.update', $r->id) }}" method="POST" onsubmit="return validateRiderForm(this)">
            @csrf
...
<div class="modal fade" id="addRiderModal" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width:480px">
    <div class="modal-content border-0" style="border-radius:1.2rem;overflow:hidden">
      ...
      <form action="{{ route('seller.riders.store') }}" method="POST" onsubmit="return validateRiderForm(this)">
        @csrf
        <div class="modal-body px-4 pt-0 pb-3">
          <div class="row g-3">
            <div class="col-sm-6">
