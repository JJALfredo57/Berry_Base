          ...
          <div class="d-flex align-items-start justify-content-between gap-2">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-end shadow border-0" style="border-radius:.8rem;min-width:150px">
                ...
                <li>
                  <form action="{{ route('seller.zones.toggle', $z->id) }}" method="POST">
                    @csrf
                ...
                <li>
                  ...
                  <form id="del-zone-{{ $z->id }}" action="{{ route('seller.zones.destroy', $z->id) }}" method="POST" style="display:none">@csrf</form>
                </li>
              </ul>
            </div>
          </div>
