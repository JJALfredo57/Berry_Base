...
.checkout-branded-content{position:relative;z-index:1;max-width:960px;margin:0 auto}
...
function validateAndSubmit(btn) {
  ...
  if (isDelivery) {
    ...
    if (deliveryCoverageBlocked) {
      alert('This pinned location is outside the seller delivery area. Move the pin inside a green coverage circle or choose pickup.');
      return false;
    }
  }
  setTimeout(() => {
